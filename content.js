...
browser.storage.local.get(['username', 'audioNotification']).then(function(items) {
	...
	settings.audioNotification = item.audioNotification;

});

// Update settings when they change in popup.js
browser.storage.onChanged.addListener(function (changes, area) {
	...
	for (var item in changes) {
		if (changes.hasOwnProperty(item) && settings.hasOwnProperty(item)) {
